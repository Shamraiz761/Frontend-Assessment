        ...
        <div className=" grid grid-rows-2 gap-6 ">
          <div className="p-5 bg-white rounded-md">
            ...
            <div className="mb-3">
              ...
              <div className="mb-5">
                <span className="flex flex-row text-gray-500   m-2 items-center text-xs font-light">
                  <MdDone className="text-blue-500 text-lg font-bold mr-2" />
                  High Rankings
                </span>

                <span className="flex flex-row text-gray-500 text-xs m-2 font-light   items-center">
                  <MdDone className="text-blue-500 font-bold text-lg mr-2" />
                  More{" "}
                </span>
                <span className="flex flex-row text-gray-500 text-xs font-light m-2  items-center">
