...
function View() {
  return (
    <div className="m-5 grid grid-cols-1 lg:grid-cols-5   gap-6">
      <div className="p-3 col-span-1 lg:col-span-3 bg-white">
        <img src={largeCard} className="w-full h-64 rounded-md" />
      ...
      <div className="p-3 bg-white col-span-1 lg:col-span-2">dskjdsk</div>
    </div>
  );
}
