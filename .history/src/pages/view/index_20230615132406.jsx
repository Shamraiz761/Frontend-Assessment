        ...
        <div className=" grid grid-rows-2 gap-6 ">
          <div className="p-3 bg-white rounded-md">
            ...
            <div className="mb-3">
              ...
              <div className="mb-3">
                <span className="flex flex-row text-gray-500   mr-8 items-center text-xs font-light">
                  <MdDone className="text-blue-500 text-lg font-bold mr-2" />
                  High Rankings
                </span>

                <span className="flex flex-row text-gray-500 text-xs font-light  mr-8 items-center">
                  <MdDone className="text-blue-500 font-bold mr-1" />
                  More{" "}
                </span>
                <span className="flex flex-row text-gray-500 text-xs font-light  mr-8 items-center">
                  <MdDone className="text-blue-500 font-bold mr-1" />
