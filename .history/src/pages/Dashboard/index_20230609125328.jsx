    ...
    <div className="mr-3">
      ...
      <div className="m-5 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 ">
        ...
        <div>
          ...
          {isModalOpen && (
            <div className="fixed w-full top-0 left-0 right-0 bottom-0 z-50   bg-opacity-50 bg-black">
              <div className="w-10/12 flex min-h-screen  items-center justify-center ml-60">
