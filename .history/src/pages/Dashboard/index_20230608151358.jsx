  ...
  return (
    <div className="m-5  w-[11/12] md:h-72 h-[360px]  bg-white">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 md:grid-cols-2 flex-row justify-between flex-wrap">
        ...
        <div className="grid my-3 grid-cols-2 md:grid-cols-4 md:justify-end justify-between mx-8 items-center overflow-scroll">
          <button className="btn border  rounded-full w-24 lg:w-28 m-1  px-4 py-2 bg-blue-600 text-sm  text-white">
            Task
          </button>
          <button className="btn border  rounded-full w-24 lg:w-28 m-1 px-4 py-2 bg-gray-300 text-sm  text-gray-800">
            Order
          </button>
          <button className="btn border  rounded-full w-24 lg:w-28  m-1 px-4 py-2 bg-gray-300 text-sm  text-gray-800">
            Submit
