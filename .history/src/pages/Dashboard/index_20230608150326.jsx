  ...
  return (
    <div className="m-5  w-[11/12] h-72 bg-white">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 md:grid-cols-2 flex-row justify-between flex-wrap">
        ...
        <div className="grid my-2 grid-cols-2 justify-end mx-8 items-center">
          <button className="btn border  rounded-full w-28 mx-2  px-4 py-2 bg-blue-600 text-sm  text-white">
            Task
          </button>
          <button className="btn border  rounded-full w-28  mx-2 px-4 py-2 bg-gray-300 text-sm  text-gray-800">
            Order
          </button>
          <button className="btn border  rounded-full w-28  mx-2 px-4 py-2 bg-gray-300 text-sm  text-gray-800">
            Submission
