...
function Chat() {
  return (
    <div className="m-5 grid grid-cols-2 lg:grid-cols-5  gap-8 flex-wrap">
      <div className="col-span-1 lg:col-span-2 p-3 bg-white rounded-lg shadow-lg min-h-screen">
        <form className="m-4">
      ...
      <div className="col-span-1 lg:col-span-3 p-3 md:col-span-3 bg-white rounded-lg shadow-lg min-h-screen">
        <UserChat />
      </div>
    </div>
  );
