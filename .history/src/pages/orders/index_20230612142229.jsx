...
import { MdHomeRepairService, MdOutlineDone } from "react-icons/md";
                  ...
                  {isOpen && (
                    <ul className="bg-white absolute right-0 mt-2 py-2 w-36 shadow rounded ">
                      <li className="text-gray-600 text-xs font-thin px-3 py-1 cursor-pointer hover:bg-gray-100">
                        <div className="flex flex-row">
                          <MdOutlineDone className="mr-2 border rounded-full " />{" "}
                          Done
                        </div>
                      </li>
                      <li className="text-gray-600 text-xs font-thin px-3 py-1 cursor-pointer hover:bg-gray-100">
                        <div className="flex flex-row">
                          <CiClock2 className="mr-2 border rounded-full " />{" "}
                          Pending
                        </div>
                      </li>
                      <li className="text-gray-600 text-xs font-thin px-3 py-1 cursor-pointer hover:bg-gray-100">
