                ...
                <div className="relative z-50">
                  ...
                  {isOpen && (
                    <ul className="bg-white absolute right-0 mt-2 py-2 w-36 shadow rounded ">
                      <li className="text-gray-600 text-xs font-thin px-3 py-1 cursor-pointer hover:bg-gray-100 focus:bg-blue-500 focus:text-white">
                        <div className="flex flex-row">
                          <MdOutlineDone className="mr-2 mt-0.5 " /> Done
                        </div>
                      </li>
                      <li className="text-gray-600 text-xs font-thin px-3 py-1 cursor-pointer hover:bg-gray-100">
                        <div className="flex flex-row">
                          <CiClock2 className="mr-2  mt-0.5" /> Pending
                        </div>
                      </li>
                      <li className="text-gray-600 text-xs font-thin px-3 py-1 cursor-pointer hover:bg-gray-100">
                        <div className="flex flex-row">
                          <MdDoNotDisturb className="mr-2 mt-0.5 " /> Decline
                        </div>
                      </li>
                    </ul>
                  )}
