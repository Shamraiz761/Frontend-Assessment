        ...
        <form className="w-full overflow-y-auto">
          <div className="flex">
            ...
            <div className="relative w-full">
              ...
              <button
                type="submit"
                className="flex-shrink-0 z-10 inline-flex items-center py-2.5 px-4 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 dark:border-gray-700 dark:text-white rounded-r-lg hover:bg-gray-200  focus:outline-none "
              >
                <BiRightArrow />
              </button>
            </div>
