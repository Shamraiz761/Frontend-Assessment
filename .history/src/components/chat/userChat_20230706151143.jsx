...
function UserChat() {
  return (
    <div className="col-span-1 md:col-span-3 p-3  overflow-y shadow-lg">
      {" "}
      <div className="flex flex-row  px-3 py-1.5 bg-black  shadow border-gray-100 rounded-sm ">
      ...
      <div className="chats ">
        <p className="text-sm bg-blue-400 rounded-md my-1 p-2 text-white flex flex-col  justify-end w-1/2">
          Hey I am there
        </p>

        <p className="text-sm bg-gray-200 rounded-md p-2  flex flex-col float-right justify-end w-1/2">
          Hey I am there
        </p>
      </div>
      <div
