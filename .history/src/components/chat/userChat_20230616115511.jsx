...
function UserChat() {
  return (
    <div className="col-span-1 md:col-span-3 p-3  bg-white rounded-lg shadow-lg overflow-y">
      {" "}
      ...
      <div className="chats ">
        <p className="text-sm bg-blue-400 rounded-md mb-1 p-2 text-white flex flex-col  justify-end w-1/2">
          Hey I am there
        </p>
