...
function Modal() {
  ...
  transition duration-150 ease-in-out origin-top min-w-32"
                          >
                            ...
                            <li className="rounded-sm relative px-3 py-1 hover:bg-gray-100  text-sm items-center text-gray-700">
                              <button className="w-full text-left flex items-center outline-none focus:outline-none">
                                <span className="pr-1 flex-1 flex flex-row">
                                  <BiUserPlus className="text-blue-500 mr-3" />
                                  Assign to
                                  <ul
                                    className="bg-white border rounded-sm transform scale-0 group-hover:scale-100 absolute 
  transition duration-150 ease-in-out origin-top min-w-32 w-40 text-center ml-28 "
                                  >
                                    ...
                                    <li className="rounded-sm  px-3 py-1 hover:bg-gray-100">
                                      <span className="pr-1 flex-1">Person 2</span>
                                    </li>
                                  </ul>
                                </span>
