              ...
              <div className="grid grid-cols-4 gap-6">
                <div className="col-span-3">
                  <div className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 flex-wrap">
                    ...
                    {/* <div className={`relative ${open ? "w-72" : "w-full"}`}> */}
                    <button onClick={toggleDueDate}>
                      <div className="card relative bg-white rounded-lg shadow-lg w-full">
                        <div className="flex flex-row justify-center items-center h-28 text-sm">
                    ...
                    {open && (
                      <div className="absolute float-right mt-32 ml-[550px] shadow w-36 rounded-md z-50 bg-white py-2 m-2">
                        <p className="text-sm text-center text-gray-700 hover:bg-gray-200">
                          Set Due Date
                        </p>
                      </div>
                    )}
