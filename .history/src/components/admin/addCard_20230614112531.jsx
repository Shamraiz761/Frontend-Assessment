          ...
          {isModalOpen && (
            <div className="fixed  top-0 left-0 right-0 bottom-0 z-50 flex items-center min-h-screen justify-center  bg-opacity-50 bg-black">
              <div className="   flex items-center justify-center ">
                <div className="   bg-slate-50 rounded-lg shadow p-8 w-72 md:w-[400px]">
                  <div className="">
                    ...
                    <div className="flex flex-row justify-between flex-wrap ">
                      ...
                      <button
                        onClick={toggleModal}
                        type="button"
                        className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 m-1 md:m-0 flex flex-row justify-center "
                      >
                        Invite
                      </button>
                    </div>
