                  ...
                  <div className="">
                    ...
                    <div className="flex flex-row justify-between flex-wrap ">
                      ...
                      <button
                        onClick={toggleModal}
                        type="button"
                        className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 m-1 md:m-0 flex justify-center "
                      >
                        Invite
                      </button>
                    </div>
