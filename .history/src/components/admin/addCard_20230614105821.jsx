    ...
    <div>
      <div className="bg-white shadow  rounded-md">
        ...
        >
          ...
          {isModalOpen && (
            <div className="fixed  top-0 left-0 right-0 bottom-0 z-50 flex items-center min-h-screen  bg-opacity-50 bg-black">
              <div className="   flex items-center justify-center ">
                <div className=" w-9/12 ml-40 bg-slate-50 rounded-lg shadow p-8 ">
                  <h1 className="text-sm">Invite Admins with their email</h1>
