  ...
  return (
    <div>
      ...
      <div className="relative">
        <div
          className={`h-screen bg-black p-3 w-56 top-0 absolute sidebar z-50`}
        >
          ...
          <div className="mt-4 flex flex-row justify-center">
            <a
              href="#"
              class="text-gray-100 bg-[#33de33] rounded-md px-6 w-full py-2.5 text-sm font-semibold hover:text-purple-600 mr-4"
            >
              Edit Profile
            </a>
          </div>
