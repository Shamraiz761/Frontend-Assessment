      ...
      >
        <div className="flex flex-row justify-center">
          <svg
            ...
            className={` text-4xl block float-left cursor-pointer rounded transition duration-500 ${
              !open && "rotate-[360deg]"
            }`}
            onClick={() => {
              setOpen(!open);
        ...
        <ul className="pt-2">
          <Link
            to="/"
            className={
              ["/tasks", "/orders", "/submission", "/payment", "/"].includes(
                pathname
              )
                ? sc
                : uc
          ...
          >
            ...
            <span
              className={` text-xs font-md flex-1 hidden-link ${
                !open && "hidden"
              }`}
            >
              Profile
          ...
          <Link
            to="/marketplace"
            className={pathname == "/marketplace" ? sc : uc}
          >
            <span className="text-xl block">
              <MdOutlineDashboard />
            </span>
          ...
          {/* Lens */}
          <Link to="/chat" className={pathname == "/chat" ? sc : uc}>
          ...
          {/* Orders */}
          <Link to="/education" className={pathname == "/education" ? sc : uc}>
            <span className="text-xl block">
